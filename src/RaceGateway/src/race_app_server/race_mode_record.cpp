...
std::string race_mode_record::to_string()
{
	...
	mystr << "race_mode_record(" << "id: " << this->id << " Timestamp: " << unsigned(this->timestamp.get_year()) << "." << unsigned(this->timestamp.get_month()) << "." << unsigned(this->timestamp.get_day()) << " " << unsigned(this->timestamp.get_hour()) << ":" << unsigned(this->timestamp.get_min()) << ":" << unsigned(this->timestamp.get_sec()) << " Status: " << this->status << " Seq: " << this->seq;
