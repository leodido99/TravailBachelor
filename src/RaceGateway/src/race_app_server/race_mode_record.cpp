...
std::string race_mode_record::to_string()
{
	...
	mystr << "race_mode_record(" << "id: " << this->id << " Timestamp: " << this->timestamp.get_year() << "." << this->timestamp.get_month() << "." << this->timestamp.get_day() << " " << this->timestamp.get_hour() << ":" << this->timestamp.get_min() << ":" << this->timestamp.get_sec() << " Status: " << this->status << " Seq: " << this->seq;
