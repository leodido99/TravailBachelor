...
public class RaceLocationPickerActivity extends AppCompatActivity
    ...
    private static final String TAG = RaceLocationPickerActivity.class.getSimpleName();
    // A default location (Neuchâtel) and default zoom to use when location permission is
    // not granted.
    private final LatLng defaultLocation = new LatLng(46.9900, 6.9293);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_race_location_picker);
    ...
    /**
     * Set the marker on the phone location
     */
