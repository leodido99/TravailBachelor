...
\begin{subfigure}[b]{1\textwidth}
   \includegraphics[width=1\linewidth]{test_planeyse_piste_1}
   \caption{Test \#1}
   \label{fig:test_piste_1}
\end{subfigure}

\begin{subfigure}[b]{1\textwidth}
   \includegraphics[width=1\linewidth]{test_planeyse_piste_2}
   \caption{Test \#2}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{test_planeyse_distance_1}
  \caption{Test \#3}
  \label{fig:test_distance_1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{test_planeyse_distance_2}
  \caption{Test \#4}
