...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.8\columnwidth]{gateway_static_archi.png} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.8\columnwidth]{gateway_dyn_archi.png} 
...
\todo{Ajout petit exemple code pour chaque}
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.5\columnwidth]{race_server_app_uml.png} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.9\columnwidth]{race_server_app_seq.png} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.5\columnwidth]{race_tracker_data_uml.png} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.7\columnwidth]{race_mode_handler_uml.png} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.6\columnwidth]{test_mode_handler_uml.png} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.3\columnwidth]{lora_pkt_forwarder_parser_uml.png} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.3\columnwidth]{lora_push_data_parser_uml.png} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.4\columnwidth]{vector_reader_uml.png} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.4\columnwidth]{shell_shell_cmd_uml.png} 
